...
//        from here
            ...
            try{
                ...
                while(rs.next() && !loginsuccess){
                    tbluname = rs.getString("username");
                    tblupass = rs.getString("password");
                    if(tbluname.equals(inpuname)&&tblupass.equals(inpupass)){
                        loginsuccess=true;
                        HttpSession session=request.getSession(false);                        
                        session.setAttribute("uemail",tbluname);
